...
import {
  getSettingsFromReg,
  getAuthTokenFromReg,
} from '../core/functions/cookie';
import {
  extractLanguagesFromReq,
  guessLanguages,
} from '../core/functions/language';
...
import { initialState as initialStateUser } from '../flux-saga/bus/fetch/users/reducers';
...
export default ({ clientStats }) => (req, res) => {
  ...
  const token = getAuthTokenFromReg(req) || '';
